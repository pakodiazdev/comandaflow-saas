    ...
    'documentations' => [
        'central' => [
            ...
            'routes' => [
                 ...
                 * Accessible at: https://comandaflow.local/api/v1/doc
                 * Nginx redirects /api/v1/doc to /api/internal/swagger/central
                 */
                'api' => 'internal/swagger/central',
                
                /*
                 * Route for accessing parsed swagger annotations.
                 */
                'docs' => 'internal/swagger/central/docs',
                 ...
                 */
                'oauth2_callback' => 'internal/swagger/central/oauth2-callback',
            ...
            'paths' => [
                ...
                */
                 ...
                 */
                'docs_json' => 'api-docs-central.json',

                /*
                 * File name of the generated YAML documentation file
                 */
                'docs_yaml' => 'api-docs-central.yaml',
            ...
            'constants' => [
                'L5_SWAGGER_CONST_HOST' => env('L5_SWAGGER_CONST_HOST', 'https://comandaflow.local'),
            ],
        ],
        'tenant' => [
            'api' => [
            ...
            'routes' => [
                 ...
                 * Route for accessing api documentation interface
                 * Accessible at: 
                 * - https://comandaflow.local/{tenant}/api/v1/doc
                 * - https://{tenant}.comandaflow.local/api/v1/doc
                 * Nginx redirects /api/v1/doc to /api/internal/swagger/tenant
                 */
                'api' => 'internal/swagger/tenant',
                
                /*
                 * Route for accessing parsed swagger annotations.
                 */
                'docs' => 'internal/swagger/tenant/docs',
                 ...
                 * Route for Oauth2 authentication callback.
                 */
                'oauth2_callback' => 'internal/swagger/tenant/oauth2-callback',
            ...
            'paths' => [
                ...
                */
                 ...
                 * File name of the generated json documentation file
                 */
                'docs_json' => 'api-docs-tenant.json',

                /*
                 * File name of the generated YAML documentation file
                 */
                'docs_yaml' => 'api-docs-tenant.yaml',
            ...
            'constants' => [
                'L5_SWAGGER_CONST_HOST' => env('L5_SWAGGER_CONST_HOST', 'https://tenant.comandaflow.local'),
            ],
        ],
    ],
    'defaults' => [
